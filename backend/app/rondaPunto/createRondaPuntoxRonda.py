...
@bp.route('/createRondaPuntoxRonda', methods=['POST'])
@cross_origin()
@jwt_required()
def createRondaPuntoxRonda():
    ...
    rondaPunto.Estado = 0
    rondaPunto.FechaCreacion = datetime.now()
    rondaPunto.UsuCreacion = idUsuario[0]
    ...
    return jsonify({"msg":"PuntoRonda creada"}), 201